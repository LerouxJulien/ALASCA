...
public class DCVM extends		AbstractDistributedCVM{
	...
	protected static final String		REQUEST_GENERATOR_JVM_URI = "request_generator_jvm_uri" ;
	...
	public void			instantiateAndPublish() throws Exception
	{
		...
		} else if (thisJVMURI.equals(REQUEST_GENERATOR_JVM_URI)) {
	...
	public void			interconnect() throws Exception
	{
		...
		if (thisJVMURI.equals(CONTROLER_JVM_URI)) {
			...
			PortI generatorOutboundPort =
					this.rg.findPortFromURI(REQUEST_GENERATOR_OUTBOUNDPORT_URI) ;
	...
	public static void main(String[] args) {
		try {
			...
			if (thisJVMURI.equals(REQUEST_GENERATOR_JVM_URI)) {
