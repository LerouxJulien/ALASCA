...
/**
 * The class <code>RequestArrivalInboundPort</code> implements the inbound port
 ...
 */
public class			RequestArrivalInboundPort
...
implements	RequestArrivalI
{
	 ...
	 * @throws Exception
	 */
	public				RequestArrivalInboundPort(
		String uri,
		ComponentI owner
		) throws Exception
	{
	...
	{
		final ServiceProvider sp = (ServiceProvider) this.owner ;
		final Request fc = c ;
