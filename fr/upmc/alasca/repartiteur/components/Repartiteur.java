...
/**
 * Le repartiteur de requete est charge de transmettre les requetes d'une unique application aux VM
 * auxquelles il est connectee.
 * Il doit être vu comme un sous-composant du Controleur, d'ou les appels directs permis du Controleur
 * aux methodes du repartiteur sans passer par des ports (processRequest et addNewPort par exemple).
 * 
 */
public class Repartiteur extends AbstractComponent implements
	...
	// compteur utilise pour differencier les ports du repartiteur vers chaque VM
	...
	/**
	 * transmet la requete r a une machine virtuelle dont la queue n'est pas pleine
	 ...
	 * @param portURI	base/prefixe de l'uri du port cree
