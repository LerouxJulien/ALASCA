...
/**
 * Classe parametrant la simulation du centre de calcul
 * Contient le main pour lancer la simulation
 *
 */
public class CVM extends AbstractCVM {
	...
	public void deploy() throws Exception {
		// processeur a 8 coeurs : toutes les machines physiques ont ce processeur
		...
		for(int i = 0 ; i < NB_COMPUTERS; ++i){
			Computer comp = new Computer(COMPUTER_INBOUNDPORT_URI + i, i, freq, 0.5,
					false, this);
		...
		this.rg = new RequestGenerator(500.0, 50000000, 20000000, numberAppLaunched,
	...
	public void			shutdown() throws Exception
	{
		PortI rgport;
		for(int i = 0; i < NB_COMPUTERS ; ++i ){
			rgport = this.cont.findPortFromURI(
					CONTROLER_OUTBOUNDPORT_URI + i) ;
	...
	public static void	main(String[] args)
	{
		...
		try {
			...
			//creation des repartiteurs dedies a l'application dont l'id leur est passe en parametre
